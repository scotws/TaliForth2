...
.scope
        ...
        ; """
                ...
                inc tmp1+1
*
                ; Get the length of the string address off the stack and
                ; increase by one because of the RTS mechanics
                pla
                sta tmp2        ; LSB of length
                pla
                sta tmp2+1      ; MSB of length

                inc tmp2
                bne +
                inc tmp2+1
*
                ; Walk through both and save them. This assumes that tmp1 and tmp2 follow
                ; each other
                ldy #0
...
*
                lda tmp2+1
                pha             ; MSB of length address
                lda tmp2
                pha             ; LSB of length address
