...
;
; "auto" means that the word is automatically tested by the test suite (good), "tested" means
; that it was tested by hand in some way (okay), "coded" means it hasn't been tested at
; all (bad). See the test suite for more details.
...
*
                ...
                ; an ANSI standard word, it doesn't appear in the docs, it's only used
