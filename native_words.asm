...
; ## CODE ( "name" -- ) "Define a word in assembler"
; ## "code"  fragment  ANS tools
...
; ## END_CODE ( -- ) "End definition of word in assembler"
; ## "end-code"  fragment  Tali
        ; """https://forth-standard.org/standard/tools/CODE
        ; End a definition of a new word in assembler that was started by
        ; CODE. See there and the documentation on assembler use for details.
        ; """
.scope
xt_end_code:
                ; TODO code me
