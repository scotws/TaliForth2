...
s_wid_asm:      .byte "Assembler", 0    ; Wordlist ID 2
s_wid_editor:   .byte "Editor", 0       ; Wordlist ID 1
s_wid_forth:    .byte "Forth", 0        ; Wordlist ID 0
s_wid_root:     .byte "Root", 0         ; Wordlist ID 3
