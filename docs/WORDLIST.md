...
| :--- | :--------- | :---   | ----: | :----  |
| COLD | `cold` | Tali Forth | 208 | coded |
...
| DUMP | `dump` | ANSI tools | 74 | coded |
| DUP | `dup` | ANSI core | 19 | tested |
| EMIT | `emit` | ANSI core | 16 | tested |
| EQUAL | `=` | ANSI core | 33 | coded |
| BLANK | `blank` | ANSI core ext | 88 | coded |
| ERASE | `erase` | ANSI core ext | 78 | coded |
| FILL | `fill` | ANSI core | 72 | coded |
