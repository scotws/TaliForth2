...
See the Appendix for a more detailed discussion of the the format. 
...
Note the 0 that is treated as the signature byte.
...
The disassembler will output this code (addresses will vary):
----
4661        nop
4662        dex  <1>
4663        nop
